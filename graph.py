class Graph:
    ...
    class Vertex:
        ...
        __slots__ = '_element', '_words_trie', '_words'

        def __init__(self, x, w_trie=None, words=None):
            self._element = x
            self._words_trie = w_trie
            self._words = words
        ...
        def words_trie(self):
            """Vraca slova - trie vezan za cvor grafa"""
            return self._words_trie

        def words(self):
            """Vraca listu svih parsiranih reci iz sajta"""
            return self._words
    ...
    def insert_vertex(self, x=None, words_trie=None, words=None):
        """ Ubacuje i vraća novi čvor (Vertex) sa elementom x"""
        v = self.Vertex(x, words_trie, words)
        self._outgoing[v] = {}
        if self.is_directed():
